      ...
      <div class="q-gutter-sm">
        <q-card class="apple-card card">
          ...
          <q-card-section class="q-pa-lg q-gutter-sm ">
            ...
            <q-input v-model="data.apiUrl" :color="showWarning()?'warning':'blue-grey'" dense label="API"
        ...
        <q-banner v-if="showWarning()" dense rounded class="text-center bg-transparent ">
          <div style="opacity:0.6">
            <q-icon name="o_lock_open" size="18px" color="red"></q-icon>
            <span class="q-ml-sm text-red  text-caption">Data is not encrypted during transmission.</span>
          </div>
        </q-banner>
      </div>
    </q-page>
...
export default {
  ...
  setup() {
    ...
    return {ui, data, onLogin, setApiUrl, getCurrentApi, updateApiUrl, showWarning}
  }
}
</script>
