    ...
    <q-card class="shadow-0">
      <q-card-section class="flex justify-between">
        ...
        <q-input
          ...
          standout
          style="width: 50%"
          @keydown.enter="requestExecuteCMD"
        ></q-input>
      </q-card-section>
      <q-table
        ...
        <template v-slot:body-cell-filename="props">
          <q-td :props="props">
            <div
              ...
              class="flex q-gutter-sm items-center no-wrap"
              style="cursor: pointer"
              @click="openFolder(props.row.path)"
            >
...
export default {
  ...
  setup(props, {emit}) {
    ...
    function requestExecuteCMD() {
      let data = {
        current_directory: params.value.directory,
        operation_command: params.value.operation_command,
      };
      showLoading($q);
      executeCMD(data)
        .then((res) => {
    ...
    function requestUploadFile() {
      ...
      uploadFile(params.value.directory, uploadFileData.value)
        .then(async (res) => {
          console.log(res);
